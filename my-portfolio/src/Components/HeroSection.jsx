...
import Img from "../images/PK.jpeg";
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-center">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start py-10 px-10">
        <h1 className="text-2xl md:text-3xl xl:text-4xl text-center md:text-left uppercase font-semibold px-11">
          Hi, I am Menz
        </h1>
      ...
      <div className="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[600px] lg:h-[500px] overflow-hidden">
